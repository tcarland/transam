/**
  ...
  *
  *  Copyright (c) 2010-2019 Timothy C. Arland <tcarland@gmail.com>
  *
...
#define TRANSAM_VERSION  "v0.8.6"
#define TRANSAM_LICENSE  "Copyright (c)2010-2019 Timothy C. Arland <tcarland@gmail.com>"
